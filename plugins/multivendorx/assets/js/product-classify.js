    ...
    var mvx_product_classify_data = {
        ...
        init: function() {
            ...
            this.$product_categories_wrap.append('<div class="mvx-product-cat-level initial-graphic select-category-graphic">\n\
                                    <img src="'+mvx_product_classify.initial_graphic_url+'" alt="select category">\n\
                                    <h1>'+mvx_product_classify.i18n.select_cat_list+'</h1></div>');
        },
        ...
        show_products_searched_by_name_gtin: function() {
            ...
            $.ajax( {
                type:     'post',
                url:      mvx_product_classify.ajaxurl,
                data:     data,
