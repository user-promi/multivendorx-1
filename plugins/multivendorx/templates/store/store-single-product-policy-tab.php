...
<div class="mvx-product-policies">
    ...
    <div class="mvx-shipping-policies policy">
        <h2 class="mvx_policies_heading heading"><?php esc_html_e( 'Store Policy', 'multivendorx' ); ?></h2>
    ...
    <div class="mvx-shipping-policies policy">
        <h2 class="mvx_policies_heading heading"><?php esc_html_e( 'Shipping Policy', 'multivendorx' ); ?></h2>
    ...
    <div class="mvx-refund-policies policy">
        <h2 class="mvx_policies_heading heading heading"><?php esc_html_e( 'Refund Policy', 'multivendorx' ); ?></h2>
    ...
    <div class="mvx-cancellation-policies policy">
        <h2 class="mvx_policies_heading heading"><?php esc_html_e( 'Cancellation / Return / Exchange Policy', 'multivendorx' ); ?></h2>
