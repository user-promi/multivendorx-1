...
<div id="product-qna" data-product="<?php echo esc_attr( $product_id ); ?>">
    ...
    <div class="header">
        ...
        <div class="qna-search">
            ...
            <button id="qna-direct-submit" class="button alt" style="display:none;"><?php echo esc_html__( 'Ask this question', 'multivendorx' ); ?></button>
        </div>
    </div>
    ...
    <?php if ( ! is_user_logged_in() ) : ?>
        <div class="login-wrapper">
            ...
            <a class="button" href="<?php echo esc_url( $login_url ); ?>"><?php echo esc_html__( 'Log in', 'multivendorx' ); ?></a>
