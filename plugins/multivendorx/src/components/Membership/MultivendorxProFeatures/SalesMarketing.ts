            ...
            rows: [
                {
                    key: 'wholesale_b2b',
                    label: 'Wholesale',
                    description: 'Offer special pricing for bulk buyers and B2B customers',
                },
                {
                    key: 'min_max_quantities',
                    label: 'Min / Max Quantities',
                    description: 'Set minimum and maximum purchase quantities per product',
                },
                {
                    key: 'advertise_product',
                    label: 'Advertise Product',
                    description: 'Promote products with featured listings and ads',
                },
                {
                    key: 'store_inventory',
                    label: 'Store Inventory',
                    description: 'Advanced stock management and inventory tracking',
                },
            ],
