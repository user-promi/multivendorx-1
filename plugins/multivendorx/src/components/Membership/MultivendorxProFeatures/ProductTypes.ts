            ...
            rows: [
                {
                    ...
                    description: 'Allow stores to sell appointment and booking-based products',
                },
                {
                    key: 'subscription',
                    label: 'Subscription Products',
                    description: 'Enable recurring subscription-based products with auto-renewal',
                },
                {
                    key: 'bundle',
                    label: 'Bundle Products',
                    description: 'Create product bundles with multiple items sold together',
                },
            ],
