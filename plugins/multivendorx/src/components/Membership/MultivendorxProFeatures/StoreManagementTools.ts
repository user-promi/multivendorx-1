            ...
            rows: [
                {
                    ...
                    description: 'Bulk import and export products, orders, and store data',
                },
                {
                    key: 'business_hours',
                    label: 'Business Hours',
                    description: 'Set custom store operating hours and schedules',
                },
                {
                    key: 'vacation_mode',
                    label: 'Vacation Mode',
                    description: 'Temporarily close store with custom vacation message',
                },
                {
                    key: 'staff_manager',
                    label: 'Staff Manager',
                ...
                },
                {
                    ...
                    description: 'Access detailed sales reports and performance insights',
                },
                {
                    key: 'store_seo',
                    label: 'Store SEO',
