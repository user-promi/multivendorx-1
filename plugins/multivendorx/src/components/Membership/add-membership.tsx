...
const Memberships = () => {
    ...
    const demoPlans = [
        ...
        },
        {
            ...
            checklist: ["50 Products", "Priority Support", "1.5% Commission", "Analytics"],
        },
        {
            id: 3,
            tag: null,
                                ...
                                <table className="admin-table">
                                    <thead className="admin-table-header">
                                        <tr className='header-row'>
                                            <th className='header-col'>Plan Name</th>
                                            <th className='header-col'>Description</th>
                                            <th className='header-col'>Price</th>
                                                ...
                                                <td className="admin-column">
                                                    <div className="table-row-custom">
                                                        <div className="product-wrapper notification">
                                                            <span className={`item-icon notification-icon adminlibrary ${plan.icon}`}></span>
                    ...
                    {viewMode === 'grid' && (
                        <div className="notification-container">
                            <div className="notification-grid">
                                {demoPlans.map((plan) => (
                                    <div className="notification-card" key={plan.id}>
                                        <div className="card-body">
                                            <div className="title-wrapper">
                                                <i className={`notification-icon ${plan.icon}`}></i>
                                                <div className="details">
                                            ...
                                            <div className="checklist-title">What's Included</div>
                                        ...
                                        <div className="card-footer">
                                            ...
                                            <div className="admin-btn btn-purple">Edit Plan</div>
                                        </div>
                                    </div>
                                ))}
                            </div>
