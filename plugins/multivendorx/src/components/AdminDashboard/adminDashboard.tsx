  ...
  const sections: Section[] = [
    {
      ...
      features: [
        { name: "VMultiple Vendors per Product (SPMV)", free: true, pro: true },
        { name: "Store Policies", free: "Basic", pro: "Advanced tiers" },
        { name: "Store Reviews", free: "Basic", pro: "Advanced analytics" },
        { name: "Follow Store", free: false, pro: true },
        { name: "Privacy Controls (Hide details)", free: false, pro: true },
    ...
    },
    {
      ...
      features: [
        ...
        { name: "PayPal Payout", free: "Basic", pro: "Advanced tiers" },
        { name: "Stripe Connect", free: "Basic", pro: "Advanced analytics" },
        { name: "Razorpay", free: false, pro: true },
    ...
    },
    {
      ...
      features: [
        { name: "Product Q&A", free: false, pro: true },
        { name: "Marketplace Refunds", free: false, pro: true },
        { name: "Announcements", free: false, pro: true },
        { name: "Report Abuse", free: false, pro: true },
    ...
    },
    {
      ...
      features: [
        { name: "Zone-Based Shipping", free: false, pro: true },
        { name: "Distance-Based Shipping", free: false, pro: true },
        { name: "Country Restrictions", free: false, pro: true },
        { name: "Weight-Based Shipping", free: false, pro: true },
    ...
    },
    {
      ...
      features: [
        { name: "Payment Gateway Fees", free: false, pro: true },
        { name: "Min/Max Quantities", free: false, pro: true },
            ...
            <div className="row">
              <div className="card-content">
                <div className="right-pro-banner">
                  ...
                  <div className="title">Join 50,000+ successful marketplace owners</div>
                  <div className="des">Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa eos saepe doloribus architecto, unde natus voluptate non dolore ipsa est!</div>
                  <ul>
                    <li><i className="adminlib-check"></i>Multi-Payment Gateway</li>
                    <li><i className="adminlib-check"></i>Multi-Payment Gateway</li>
                    <li><i className="adminlib-check"></i>Multi-Payment Gateway</li>
                    <li><i className="adminlib-check"></i>Multi-Payment Gateway</li>
                    <li><i className="adminlib-check"></i>Multi-Payment Gateway</li>
