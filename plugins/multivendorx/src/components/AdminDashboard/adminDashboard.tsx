  ...
  const sections: Section[] = [
    {
      title: "Core Features",
      features: [
        { name: "Basic Plugin Functionality", free: true, pro: true },
        { name: "Advanced Tools", free: false, pro: true },
    ...
    },
    {
      ...
      features: [
        { name: "WooCommerce", free: true, pro: true },
        { name: "Stripe", free: false, pro: true },
        { name: "Zapier", free: false, pro: true },
        { name: "Custom Widgets", free: false, pro: true },
        { name: "Custom Widgets", free: false, pro: true },
        { name: "Custom Widgets", free: false, pro: true },
            ...
            return (
              <div key={section.title} className="features-wrapper">
                ...
                >
                  ...
                  <i
                    className={`adminlib-pagination-right-arrow ${isOpen ? "rotate-180" : ""
                      }`}
                  >
                  </i>
                </div>
      ...
      <div className="admin-dashboard">
        ...
        <div className="header">
          <div className="title-wrapper">
            ...
            <div className="des">Turn your WooCommerce store into a thriving marketplace. Let's get you started with the essentials.</div>
          </div>
        </div>
