            ...
            <div className="form-group-wrapper">
                <div className="form-group">
                    <ul className="check-list">
                        <li><i className="close adminlib-cross"></i>Log in to dashboard</li>
                        <li><i className="close adminlib-cross"></i>Access selling privileges</li>
                        <li><i className="close adminlib-cross"></i>Submit reapplication or appeal</li>
                        <li><i className="close adminlib-cross"></i>View or manage product listings</li>
                        <li><i className="close adminlib-cross"></i>Retain any marketplace privileges</li>
                    </ul>
                </div>
            </div>
            {/* <div className="form-group-wrapper">
