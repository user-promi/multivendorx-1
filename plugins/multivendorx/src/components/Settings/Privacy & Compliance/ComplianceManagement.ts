                            ...
                            options: [
                                {
                                    ...
                                    desc: __('Prevents the store from accessing its dashboard until verification is completed.', 'multivendorx'),
                                },
                                {
                                    key: 'hide_store_from_view',
                                    label: __('Hide store from view', 'multivendorx'),
                                    value: 'hide_store_from_view',
                                    desc: __('Hides the store from customers until verification is completed.', 'multivendorx'),
                                },
                                {
                                    key: 'disable_product',
                        ...
                        },
                        {
                            ...
                            options: [
                                ...
                                },
                                {
                                    ...
                                    desc: __('Moves the store to a pending status, preventing further activity until compliance issues are resolved.', 'multivendorx'),
                                },
                                {
                                    key: 'notify_admin_only',
                                    label: __('Notify admin only', 'multivendorx'),
                                    value: 'NotifyAdmin',
                                    desc: __('Sends a notification to the admin about the compliance issue without restricting the store’s activity.', 'multivendorx'),
                                },
                            ],
                            selectDeselect: true,
                        },
                            ...
                            options: [
                                {
                                    ...
                                    desc: __('Prevents the store from accessing its account until compliance issues are resolved.', 'multivendorx'),
                                },
                                {
                                    key: 'restrict_marketplace_features',
                                    label: __('Restrict features', 'multivendorx'),
                                    value: 'RestrictMarketplaceFeatures',
                                    desc: __('Limits specific store features while still allowing basic access.', 'multivendorx'),
                                },
                                {
                                    key: 'notify_admin_only',
                                    label: __('Notify admin only', 'multivendorx'),
                                    value: 'NotifyAdmin',
                                    desc: __('Alerts the admin about the compliance issue without restricting the stores activity.', 'multivendorx'),
                                },
                            ],
                            selectDeselect: true,
                        },
