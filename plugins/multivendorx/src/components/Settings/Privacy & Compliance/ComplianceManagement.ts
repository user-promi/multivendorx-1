							...
							items: [
								{
									...
									tags: `<a class="admin-btn purple" href="${appLocalizer.site_url}/wp-admin/admin.php?page=multivendorx#&tab=settings&subtab=store-identity">${__('Set Up', 'multivendorx')}</a>`,
								},
								{
							...
							items: [
								{
									...
									tags: `<a class="admin-btn purple" href="${appLocalizer.site_url}/wp-admin/admin.php?page=multivendorx#&tab=settings&subtab=product-compliance">${__('Set Up', 'multivendorx')}</a>`,
								},
								{
							...
							items: [
								{
									...
									tags: `<a class="admin-btn purple" href="${appLocalizer.site_url}/wp-admin/admin.php?page=multivendorx#&tab=settings&subtab=legal-compliance">${__('Set Up', 'multivendorx')}</a>`,
								},
								{
							...
							items: [
								{
									...
									tags: `<a class="admin-btn purple" href="${appLocalizer.site_url}/wp-admin/admin.php?page=multivendorx#&tab=settings&subtab=tax-compliance">${__('Set Up', 'multivendorx')}</a>`,
								},
								{
