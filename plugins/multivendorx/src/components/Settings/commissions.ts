...
export default {
    ...
    modal: [
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    value: __('fixed_with_percentage_per_transaction', 'multivendorx'),
                },
                {
        ...
        },
        {
            ...
            type: "multi-number",
            label: __("Commission Value", "multivendorx"),
            desc: __("This is the default commission amount that will be applicable for all transactions.", "multivendorx"),
            options: [
              {
        ...
        },
        {
            ...
            options: [
              ...
              },
              {
                ...
                label: __("Percentage", "multivendorx"),
                type: "number",
                desc: __("Percentage of product price per unit", "multivendorx"),
              },
            ],
            dependent: {
                key: "commission_type",
