    ...
    modal: [
        {
            ...
            desc: __('Franchise stores can manually place orders for products they manage. Here global marketplace commission rules apply.', 'multivendorx'),
            type: 'checkbox',
            options: [
                {
                    key: 'enable_franchise',
        ...
        },
        {
            ...
            settingDescription: __('Permit franchise stores to create order from the admin products.', 'multivendorx'),
            type: 'checkbox',
            options: [
                {
                    key: 'allow_store_create_orders',
        ...
        },
        {
            ...
            settingDescription: __('Let franchise stores adjust the selling price of admin-owned products based on requirements.', 'multivendorx'),
            type: 'checkbox',
            options: [
                {
                    key: 'allow_store_orders_admin',
        ...
        },
        {
            ...
            type: 'section',
            hint: __(
                'Order fulfillment and assignment',
                'multivendorx'
            ),
        },
        {
            ...
            settingDescription: __('Automatically assign customer orders to the nearest eligible franchise store based on location.', 'multivendorx'),
            type: 'checkbox',
            options: [
                {
                    key: 'enable_automatic_assignment',
        ...
        },
        {
            ...
            type: 'section',
            hint: __(
                'Franchise service area controls',
                'multivendorx'
            ),
        },
        {
            ...
            settingDescription: __('Limit franchise store operations to defined geographic areas such as city, state, or postal code.', 'multivendorx'),
            type: 'checkbox',
            options: [
                {
                    key: 'restrict_location',
