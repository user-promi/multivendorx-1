...
export default {
	...
	modal: [
		...
		},
		{
			...
			desc: __(
				'Choose how customer orders are assigned to franchise stores:<ul><li><strong>Nearest store</strong> - Orders are automatically assigned to the franchise store closest to the customer’s address, ensuring faster fulfillment.</li><li><strong>Manual assignment</strong> - Orders remain unassigned until an admin manually selects which franchise store will fulfill them.</li></ul>',
				'multivendorx'
			),
