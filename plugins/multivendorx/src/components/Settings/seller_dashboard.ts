...
export default {
    ...
    desc: __(
        "Manage the appearance of your seller's dashboard.",
        'multivendorx'
    ),
    ...
    modal: [
        ...
        },
        {
            ...
            desc: sprintf(
                __(
                    'Allows vendors to request the deactivation of their profiles. To know more, please <a href="%s">click here</a>.',
                    'multivendorx'
                ),
                'https://multivendorx.com/docs/knowledgebase/vendor-account-deactivation-flow/'
            ),
            options: [
                {
                    key: 'vendor_deactivation_enabled',
        ...
        },
        {
            ...
            desc: __(
                'Set endpoint for vendor announcements page',
                'multivendorx'
            ),
        ...
        },
        {
            ...
            desc: __(
                'Used as site logo on vendor dashboard pages',
                'multivendorx'
            ),
        ...
        },
        {
            ...
            desc: __(
                'Set endpoint for vendor profile management page',
                'multivendorx'
            ),
        ...
        },
        {
            ...
            desc: __(
                'Set endpoint for vendor widthdrawals page',
                'multivendorx'
            ),
        ...
        },
        {
            ...
            desc: __(
                'Set endpoint for transaction details page',
                'multivendorx'
            ),
        ...
        },
        {
            ...
            desc: __(
                'Set endpoint for vendor products Q&As page',
                'multivendorx'
            ),
        ...
        // Required module Name : Seller Identity Verification
        {
            ...
            desc: __(
                'Set endpoint for vendor verification page',
                'multivendorx'
            ),
        ...
        // Required module Name : Staff Manager
        {
            ...
            desc: __(
                'Set endpoint for vendor add staff page',
                'multivendorx'
            ),
        ...
        },
        {
            ...
            desc: __(
                'Set endpoint for vendor manage staff page',
                'multivendorx'
            ),
