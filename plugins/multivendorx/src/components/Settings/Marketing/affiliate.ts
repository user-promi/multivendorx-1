	...
	modal: [
		{
			...
			desc: __('Select who is responsible for paying affiliate referral commissions:<ul><li>Admin - The marketplace admin pays affiliates for referrals.</li><li>Store - Individual stores pay affiliates for referrals generated through their products.</li></ul><strong>Example setup:</strong><br>' + 'Total product price = $1,000<br>' + 'Marketplace commission = 20%<br>' + 'Affiliate commission = $50 + 5%<br>' + '<em>(Affiliate commission is calculated on the total product price)</em>' + '<ul>' + '<li><strong>Option 1 – Admin pays affiliate:</strong><br>' + 'Marketplace commission = 20% of $1,000 = $200<br>' + 'Affiliate commission = $50 + 5% of $1,000 = $100<br>' + 'Store receives = $1,000 − $200 = $800<br>' + '<em>(Affiliate cost is covered by the marketplace)</em></li>' + '<li><strong>Option 2 – Store pays affiliate:</strong><br>' + 'Marketplace commission = 20% of $1,000 = $200<br>' + 'Affiliate commission = $50 + 5% of $1,000 = $100<br>' + 'Store receives = $1,000 − ($200 + $100) = $700</li>' + '</ul>', 'multivendorx' ),
			proSetting: true,
			moduleEnabled: 'wp-affiliate',
			options: [
				{
