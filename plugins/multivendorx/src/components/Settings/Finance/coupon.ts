...
export default {
    ...
    modal: [        
        ...
        },
        {
            ...
            desc: __(
                'When a coupon is created by the admin, the "Who bears the coupon cost" setting is ignored. Store commission is always calculated according to the commission rules defined by the admin',
                'multivendorx'
            ),
            type: 'checkbox',
            options: [
