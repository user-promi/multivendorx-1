...
const Invoice1: React.FC<Props> = ({ invoiceRows, colors }) => {
	const rows: Row[] = invoiceRows || [
		{
			description: 'Widget A – Premium Edition',
			qty: 2,
			unitPrice: '$50.00',
			subtotal: '$100.00',
			taxRate: '10%',
		...
		{
			description: 'Widget B – Deluxe Model',
			qty: 1,
			unitPrice: '$75.00',
			subtotal: '$75.00',
			taxRate: '10%',
				...
				<View>
					...
					>
						...
						>
							...
							>
								...
								<Text id="address" style={{ color: '#fff' }}>
									123 Commerce Street
								</Text>
								<Text id="address" style={{ color: '#fff' }}>
									London, EC1A 1BB
					...
					>
						<Text style={{ fontSize: '12px', fontWeight: 'bold' }}>
							Notes:{' '}
							<Text style={{ fontSize: '10px' }}>
								This invoice covers items sold by Premium
								Electronics Store. Tax amounts shown are
								calculated based on applicable VAT/GST rates for
								the delivery jurisdiction. For questions
								regarding this invoice, please contact the
								seller directly.
							</Text>
						</Text>
					</View>
