        ...
        <>
            ...
            <Container general>
                <Column grid={6}>
                    ...
                    >
                        <FormGroupWrapper>
                            <FormGroup row label={__('Product *', 'multivendorx-pro')} >
                                <BasicInputUI type="number" />
                            </FormGroup>
                            <FormGroup row label={__('Customer *', 'multivendorx-pro')} >
                    ...
                    >
                        <FormGroupWrapper>
                                ...
                                <ChoiceToggleUI
                                    options={[
                                        ...
                                        },
                                        {
                                            key: 'mile',
                                            value: 'mile',
                                            label: __('Assign to an existing order', 'multivendorx'),
                                        },
                                    ]}
                            ...
                            <FormGroup row label={__('Existing Order', 'multivendorx-pro')} >
                                <BasicInputUI type="number" />
                            </FormGroup>
                            <FormGroup row label={__('Billing', 'multivendorx-pro')} >
                                <BasicInputUI type="text"  />
                            </FormGroup>
                        </FormGroupWrapper>
                    </Card>
                ...
                <Column grid={6}>
                    ...
                    >
                        <FormGroupWrapper>
                            ...
                            <FormGroup
                                row
                                label={__('Repeat / Recurrence', 'multivendorx-pro')}
                            >
                                <SelectInputUI
                                    name="repeat"
                                    size="15rem"
                            ...
                            <FormGroup row label={__('Location', 'multivendorx-pro')} >
                                <BasicInputUI type="number" />
                            </FormGroup>
                        </FormGroupWrapper>
                    </Card>
