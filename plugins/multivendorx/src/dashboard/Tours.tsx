...
export const getTourSteps = (appLocalizer: AppLocalizer): TourStep[] => [
	{
		selector:
			'.store-dashboard .analytics-container .analytics-item:first-child',
		placement: 'auto',
	...
	{
		selector: '.settings-wrapper .tabs-wrapper',
		placement: 'right',
	...
	{
		selector: '.settings-wrapper .container-wrapper',
		placement: 'right',
	...
	{
		selector: '.table-wrapper .admin-table-body .admin-row:first-child',
		placement: 'right',
