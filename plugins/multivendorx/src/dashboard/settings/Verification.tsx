        ...
        <>
            ...
            <div className="card-wrapper">
                <div className="card-content">
                    <div className="card-title">{__('Identity Documents', 'multivendorx')}</div>
                        ...
                        method.active && (
                            <div key={index} className="varification-wrapper">
                                <div className="left">
                                    ...
                                    {method.required && <span className="required-badge">{__('Required', 'multivendorx')}</span>}
                                </div>
                                <div className="right">
                                    <div className="admin-btn btn-purple">{__('Verify Now', 'multivendorx')}</div>
                                </div>
                            </div>
                        )
                    ))}

                    <div className="card-title">{__('Required Information', 'multivendorx')}</div>

                    {/* Add your required information fields here */}

                    <div className="card-title">{__('Social Profiles', 'multivendorx')}</div>
