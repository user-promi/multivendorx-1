				...
				return (
					<Container>
						<Notice
							...
							message={__(
								'All product listings must follow platform guidelines. Branded or regulated products require authenticity certificates. Upload the required documents to keep your listings active.',
								'multivendorx'
							)}
						/>
						<Column row>
							...
							>
								<Notice
									...
									displayPosition="inline-notice"
									message={__(
										'3 of your products are missing descriptions or have low-quality images. Fix them to avoid listing suspension.',
										'multivendorx'
									)}
								/>
							</Card>
							...
							>
								<ItemListUI
									...
									items={[
										{
											title: __(
												'Nike Air Max — Authenticity Certificate',
												'multivendorx'
											),
											desc: __(
						...
						<Column row>
							...
							>
								...
								<Notice
									...
									displayPosition="inline-notice"
									message={__(
										'Recommended for electronics, cosmetics, and baby products to build buyer confidence.',
										'multivendorx'
									)}
								/>
							</Card>
							...
							>
								...
								<Notice
									...
									displayPosition="inline-notice"
									message={__(
										'Multiple reports can result in product removal or account penalties. Ensure all listings comply with platform guidelines.',
										'multivendorx'
									)}
								/>
							</Card>
				...
				return (
					<Container>
						<Notice
							...
							displayPosition="inline-notice"
							title={__(
								'Payouts Currently On Hold',
								'multivendorx'
							)}
							message={__(
								'Your bank account verification is pending. Payouts will be released within 2–3 business days once your bank details and tax documents are verified by our team.',
								'multivendorx'
							)}
						/>
						<Column grid={6}>
				...
				return (
					<>
						...
						<Notice
							...
							displayPosition="inline-notice"
							message={__(
								'5 products have compliance issues. Fix them to keep listings active and avoid restrictions.',
								'multivendorx'
							)}
						/>
					</>
