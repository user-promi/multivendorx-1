...
class Admin {
    ...
    public function product_single_product_multivendor_tab_template() {
        ...
        MultiVendorX()->util->get_template(
            'product/multiple-vendors-products.php',
            array(
				'results'            => $results,
				'more_product_array' => $more_product_array,
			)
        );
    }
    ...
    public function product_single_product_multivendor_tab_link() {
        ...
        if ( is_product() ) {
            MultiVendorX()->util->get_template( 'product//multiple-vendors-products-link.php', array( 'more_products' => $more_products ) );
        }
    }
}
