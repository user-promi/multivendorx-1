jQuery( document ).ready( function ( $ ) {
	...
	function initialize() {
		var lat =
			$( '#multivendorx_user_location_lat' ).val() ||
			mvx_checkout_map_options.default_lat;
		var lng =
			$( '#multivendorx_user_location_lng' ).val() ||
			mvx_checkout_map_options.default_lng;
