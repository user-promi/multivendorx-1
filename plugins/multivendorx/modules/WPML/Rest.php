...
class Rest extends \WP_REST_Controller
{
    ...
    public function get_items($request)
    {
        ...
        try {
            ...
            foreach ($languages as $lang) {
                ...
                // Only check translation if not current language
                if ($lang['code'] !== $current_language && $trid) {
                ...
                $response[] = array(
                    ...
                    'translated_product_id'  => $translated_product_id ? absint($translated_product_id) : null,
                );
            }
    ...
    public function update_item($request)
    {
        ...
        try {
             ...
             * mark_as_duplicate = false → independent product
             */
