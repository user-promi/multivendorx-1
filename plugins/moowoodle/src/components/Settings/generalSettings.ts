...
export default {
    ...
    modal: [
        ...
        },
        {
            ...
            desc: __(
                `Enter Moodle access token. You can generate the access token from <a href="${appLocalizer.moodle_site_url}admin/webservice/tokens.php" target="_blank">here</a>. <br> Navigation: Dashboard => Site administration => Server => Manage tokens. `,
                "moowoodle"
            ),
        },
        {
