...
export default {
    ...
    modal: [
        ...
        },
        {
            ...
            type: "checkbox",
            desc: __(
                `If enabled, default WordPress new user registration emails will be disabled for both admin and user. <br>You can personalize the content of the MooWoodle New User email from  <a href="${appLocalizer.wc_email_url}" target="_blank">here.</a>`,
                "moowoodle"
            ),
