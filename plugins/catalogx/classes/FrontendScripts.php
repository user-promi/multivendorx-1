            ...
            array(
				'catalogx-admin-script'                 => array(
					...
					'data'        => array(
						...
						'enquiry_messages_bg'        => CatalogX()->plugin_url . 'src/assets/images/enquiry-page-desktop.png',
						'quote_requests_bg'          => CatalogX()->plugin_url . 'src/assets/images/quote-page-desktop.png',
						'wholesale_users_bg'         => CatalogX()->plugin_url . 'src/assets/images/wholesale-pro.png',
						'dynamic_rules_bg'           => CatalogX()->plugin_url . 'src/assets/images/dynamic-pro.png',
