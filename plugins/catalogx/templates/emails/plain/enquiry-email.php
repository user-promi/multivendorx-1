...
echo "\n Product Name : " . esc_html( $product_obj->get_name() );
...
echo "\n\n Product link : " . esc_url( $product_obj->get_permalink() );
...
echo "\n\n\n Name : " . esc_html( $enquiry_data['cust_name'] );

echo "\n\n Email : " . esc_html( $enquiry_data['cust_email'] );
