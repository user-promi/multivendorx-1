...
export type PaginationProps = {
  ...
  perPage: number;
  total: number;
  onPageChange?: (page: number, action?: 'previous' | 'next' | 'goto' | 'first' | 'last') => void;
...
const Pagination: React.FC<PaginationProps> = ({
  ...
  // --- PagePicker Logic ---
  const goToPage = (newPage: number, action?: 'previous' | 'next' | 'goto' | 'first' | 'last') => {
              ...
              {pages.map((pageNum, idx) =>
                typeof pageNum === 'number' ? (
                  <ButtonInputUI
                    ...
                    buttons={{
                      text: String(pageNum),
                      color: page === pageNum ? 'purple' : 'white',
