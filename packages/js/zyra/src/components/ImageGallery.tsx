...
const ImageGallery: React.FC< ImageGalleryProps > = ( {
    ...
    const [ localSelected, setLocalSelected ] =
        useState< ImageItem[] >( selectedImages );
    ...
    const mockImages: ImageItem[] = [
        {
            id: '1',
            url: 'https://www.google.com/url?sa=i&url=https%3A%2F%2Fpicjumbo.com%2Ffree-images%2Fnature%2F&psig=AOvVaw2X_9wUirx9YNWP52nbvnqV&ust=1761216292635000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCIiUi5PQt5ADFQAAAAAdAAAAABAE',
            alt: 'Placeholder 1',
        },
        {
            id: '2',
        ...
        {
            id: '4',
            url: 'https://via.placeholder.com/300x200/0000FF',
            alt: 'Placeholder 4',
        },
    ];
    ...
    const handleImageClick = ( image: ImageItem ) => {
        ...
        if ( multiple ) {
            ...
            if ( isAlreadySelected ) {
                newSelected = localSelected.filter(
                    ( selected ) => selected.id !== image.id
                );
            } else {
