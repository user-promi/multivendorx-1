...
export const CountryCodesObject = {
  ...
  CD: { name: "Congo, The Democratic Republic of the Congo", dial_code: "+243" },
  ...
  KP: { name: "Korea, Democratic People's Republic of Korea", dial_code: "+850" },
  ...
  FM: { name: "Micronesia, Federated States of Micronesia", dial_code: "+691" },
  ...
  VE: { name: "Venezuela, Bolivarian Republic of Venezuela", dial_code: "+58" },
