            ...
            <div className="section-wrapper color">
              <div className="simple">
                {[
                  ...
                  { label: "Font Color", key: "button_text_color" }
                ].map(({ label, key }) => (
              ...
              <div className="hover" onMouseEnter={() => setHoverOn(true)} onMouseLeave={() => setHoverOn(false)}>
                {[
                  { label: "Background Color On Hover", key: "button_background_color_onhover" },
                  { label: "Font Color On Hover", key: "button_text_color_onhover" }
                ].map(({ label, key }) => (
                  <div key={key} className="section">
                    <span className="label">{label}</span>
                    <div className="property-section">
