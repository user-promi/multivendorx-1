	...
	return (
		<>
			<div className="loader-wrapper">
				<button className="admin-btn btn-purple btn-effect" onClick={handleSync}>
					{value}
				</button>
				{(loading || syncStarted) && (
			...
			<p className="settings-metabox-description" dangerouslySetInnerHTML={{ __html: description }} />
								...
								<span className="status-icons">
									<i
										className={`admin-font ${
											task.status === 'failed' ? 'adminlib-cross' : 'adminlib-icon-yes'
										}`}
									/>
								</span>
							</div>
